                    ...
                    <div class="row align-items-end">
                        <div class="col-lg-12 ml-3">
                            <div class="page-header-title">
                                <div class="d-inline">
                                    <h4>Add Employee Contracts</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                {!! Form::open(['url'=>'/employee_management/add_employee_contracts','method'=>'post', 'enctype'=>'multipart/form-data']) !!}	
                <form action=""method="" >	
				<div class="page-body">
					<div class="row">
							...
							<div class="card row">
								<div class="card-block">
									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control" placeholder="Enter Start Date" name="employee_name" required>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control" placeholder="Enter Your company name" name="company_name" id="comp_name" required>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<input type="date" class="form-control" placeholder="Enter Start Date" name="start_date" required>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<input type="date" class="form-control" placeholder="Choose End Date" name="end_date" required>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control" placeholder="Choose Your position" name="position" required>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<input type="number" class="form-control" placeholder="Choose Your salary" name="salary" required>
										</div>
									</div>
								</div>

                                <div class="mb-3 pl-3">
                                    <button type="submit" class="btn btn-success btn-square pull-right mr-5"> <i class="icofont icofont-check-circled">Add Employee Contracts</button>
                                </div>
