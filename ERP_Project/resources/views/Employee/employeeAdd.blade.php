				...
				<div class="page-body">
					<div class="row">
							...
							<div class="card row">
								<div class="card-block">
									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control" placeholder="Enter Your Father's Name" name="emp_father_name" required>
										</div>
									</div>
									<div class="form-group row">
									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<input type="date" class="form-control" placeholder="Enter Your Date of Birth" name="emp_date_of_birth" required>
										</div>
									</div>
									<div class="row">
									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<input type="number" class="form-control" placeholder="Enter Your Phone Number" name="emp_phone_number" required>
										</div>
									</div>
									<div class="form-group row">
										<label class="col-sm-4 col-form-label">Image</label>
										<div class="col-sm-8">
											<input type="file" class="form-control" placeholder="Choose Your image" name="emp_image" required>
										</div>
									</div>
									<div class="form-group row">
										<label class="col-sm-4 col-form-label">Local Address</label>
										<div class="col-sm-8">
											<textarea rows="5" cols="5" class="form-control" placeholder="Enter Your Local Address" name="emp_local_address" required></textarea>
										</div>
									</div>
									<div class="form-group row">
										<label class="col-sm-4 col-form-label">Permanent Address</label>
										<div class="col-sm-8">
											<textarea rows="5" cols="5" class="form-control" placeholder="Enter Your Permanent Address" name="emp_permanent_address" required></textarea>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="card row">
								<div class="card-block">
									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<input type="file" class="form-control" placeholder="Enter Your Resume" name="emp_resume">
										</div>
									</div>
									<div class="form-group row">
										<label class="col-sm-4 col-form-label">Joining Letter</label>
										<div class="col-sm-8">
											<input type="file" class="form-control" placeholder="Enter Your Joining Letter" name="emp_joining_letter">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<input type="file" class="form-control"  name="emp_contract">
										</div>
									</div>
									<div class="form-group row">
										<label class="col-sm-4 col-form-label">Id Proof</label>
										<div class="col-sm-8">
											<input type="file" class="form-control"  name="emp_id_proof">
										</div>
									</div>
								</div>
							</div>
							...
							<div class="card row">
								<div class="card-block">
									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<input type="number" class="form-control" placeholder="Enter Your Joining Salary" name="emp_joining_salary" required>
										</div>
									</div>
									<div class="form-group row">
										<label class="col-sm-4 col-form-label">Team Leader</label>
										<div class="col-sm-8">
											<input type="email" class="form-control" placeholder="Enter team leader email" name="emp_team_leader">
										</div>
									</div>
								</div>
							</div>
							...
							<div class="card row">
								<div class="card-block">
									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control" placeholder="Your Account Name" name="emp_account_name" id="result" required="true" readonly="true">
										</div>
									</div>
									<div class="form-group row">
										<label class="col-sm-4 col-form-label">Account Number</label>
										<div class="col-sm-8">
											<input type="number" class="form-control" placeholder="Enter Your Account Number" name="emp_account_number" required="true">
										</div>
									</div>
									<div class="form-group row">
										<label class="col-sm-4 col-form-label">Bank Name</label>
										<div class="col-sm-8">
											<input type="text" class="form-control" placeholder="Enter Your Bank Name" name="emp_bank_name" required="true">
										</div>
									</div>
									<div class="form-group row">
										<label class="col-sm-4 col-form-label">Branch</label>
										<div class="col-sm-8">
											<input type="text" class="form-control" placeholder="Enter Your Branch" name="emp_branch" required="true">
										</div>
									</div>
									<div class="form-group row">
										<label class="col-sm-4 col-form-label">SWIFT Code(optional)</label>
										<div class="col-sm-8">
											<input type="number" class="form-control" placeholder="Enter Your SWIFT Code" name="emp_swift_code" >
										</div>
									</div>
								</div>
							</div>
						...
						<div class="form-group row" >
							...
							<div class="col-sm-8">
								<select name="emp_other_leave" class="form-control">
									<option value="0" disabled="true" selected="true">Select Days</option>
									@for($j=0;$j<=31;$j++){
									<option value="{{$j}}">{{$j}}</option>;
								}
...
<div class="mr-4 pr-3">
	<button type="submit" class="btn btn-success btn-square pull-right mr-5"><i class="fa fa-plus" aria-hidden="true"></i>Add Employee</button>
	</div>
