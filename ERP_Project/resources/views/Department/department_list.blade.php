                                    ...
                                    <div class="portlet-body">
                                        <table class="table table-striped table-bordered table-hover">
                                            ...
                                            <tr id="row1">
                                                ...
                                                <td>
                                                    <a class="btn green-meadow"  data-toggle="modal" href="#" onclick="showEdit(1,'PHP')"><i class="fa fa-edit"></i> View/Edit</a>
                                                    <a class="btn red" href="#"><i class="fa fa-trash"></i> Delete</a>
                                                </td>
                                            </tr>
