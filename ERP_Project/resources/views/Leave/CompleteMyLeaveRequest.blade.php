					...
					<tbody>
						...
						<tr>
							...
							<td style="text-align: center;">
								@if($leave_request->status == 0)
								<a href="{{url('/task_management/individual_task_edit')}}/{{$leave_request->id}}" class="btn btn-info" role="button" title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Review Request</a>
								@else
