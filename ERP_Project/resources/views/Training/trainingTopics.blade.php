		...
		<div class="main-body">
			<div class="page-wrapper">
				...
				<div class="caption" style="padding-top: 15px; padding-bottom: 15px; background-color: 	#202020; font-size: 18px; color:white;">
					<i class="fa fa-cogs" style="padding-top: 8px; padding-bottom: 8px; padding-left: 5px"></i> Manage Training Topics
				</div>
				...
				<form name="add_name" id="add_name">  
					...
					<div class="table-responsive">  
						<table class="table table-bordered" id="dynamic_field">  
							<tr>  
								<td><input type="text" name="name[]" placeholder="Enter Training Topics" class="form-control name_list" /></td>  
...
<script type="text/javascript">
    $(document).ready(function(){      
      var postURL = "<?php echo url('/training_management/training_topics'); ?>";
      var i=1;  
